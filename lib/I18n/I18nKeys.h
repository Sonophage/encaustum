...
enum class StrId : uint16_t {
  ...
  STR_HIGHLIGHT_END,
  STR_HIGHLIGHT_HOLD,
  STR_EXPORT_HIGHLIGHTS,
  STR_HIGHLIGHTS_EXPORTED,
  STR_EXPORT_FAILED,
  ...
  STR_LOOKING_UP,
  STR_WORD_NOT_FOUND,
  STR_PRESS_CONFIRM_SUGGESTIONS,
  STR_FINDING_SUGGESTIONS,
  STR_DID_YOU_MEAN,
  STR_NO_SIMILAR_WORDS,
  STR_LOOKUP_HISTORY,
  STR_NO_HISTORY_FOUND,
  STR_DELETE_WORD_PROMPT,
  STR_DICT_INDEX_BUILDING,
  STR_DICT_INDEX_BUILDING_HINT,
  STR_SCROLL,
  STR_UP_DOWN,
  STR_PREV,
  STR_NEXT,
